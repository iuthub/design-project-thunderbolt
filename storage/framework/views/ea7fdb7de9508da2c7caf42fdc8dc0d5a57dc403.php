...
<div align="right">
	<a href="<?php echo e(route('feedcont.index')); ?>" class="btn btn-default">Back</a>
</div>
<br />

<form method="post" action="<?php echo e(route('feedcont.update', $data->id)); ?>" enctype="multipart/form-data">
...
<?php /* /home/khurshid/Desktop/design-project-thunderbolt/resources/views/feedbacks/edit.blade.php */ ?>