...
class MenusController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('mcont')->with('success', 'Data Added successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('mcont')->with('success', 'Data is successfully updated');
    ...
    public function destroy($id)
    {
        $data = Menu::findOrFail($id);
        $data->delete();
        return redirect('mcont')->with('success', 'Data is successfully deleted');
    }
}
